...
describe("Observed attributes", () => {
  ...
  it("Boolean attributes are turned into booleans", async () => {
    ...
    const el = (await fixture(
      html`<attrs-boolean-test open></attrs-boolean-test>`
  ...
  it("Boolean attributes are undefined when not present", async () => {
    ...
    const el = (await fixture(
      html`<attrs-boolean-false-test></attrs-boolean-false-test>`
    )) as HTMLElement & Props;
  ...
  it("renderer receives component as this context", async () => {
    ...
    const el = await fixture(html`<attrs-test-2></attrs-test-2>`);
  ...
  it("observed attribute names turn into camelCase props", async () => {
    ...
    customElements.define(
      tag,
      component<HTMLElement & Props>(Drawer, {
        observedAttributes: [
          "open",
          "open-a",
          "open-b-b",
    ...
    (await fixture(html` <attrs-camelcase-test
      open
      open-a
      open-b-b
      openc-
